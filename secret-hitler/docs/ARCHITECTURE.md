...
How the app is put together. For installing, playing and contributing, see the
[README](../README.md).
...
| `tailwind.config.js` | 1930s palette and type scale | The reducer is complete enough to drive all of them.
